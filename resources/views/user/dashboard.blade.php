											...
											<div class="lp-list-view-inner-contianer lp-border lp-border-radius-8 clearfix">
												<div class="lp-list-view-thumb">
													<div class="lp-list-view-thumb-inner">
														<img src="/images/healthcare/{{$book['healthcare'][0]['pro_pic']}}" alt="list-1">
													</div>
												...
												<div class="lp-list-view-content">
													...
													<h3 class="booking-id">Booking ID: CH{{$book['id']}}</h3>
														<h4>{{$book['healthcare'][0]['name']}}</h4>
														<div class="user-portfolio-stat padding-top-0">
												<ul>
													<li>
														<i class="fa fa-map-marker"></i>
														<span>{{$book['healthcare'][0]['address']}}</span>
													</li>
													<li>
														<i class="fa fa-phone"></i>
														<span>{{$book['healthcare'][0]['mobile']}}</span>
													</li>
												...
												<div class="lp-list-view-paypal">
													<div class="lp-list-view-paypal-inner">
														...
														<div class="lp-list-pay-btn">
															<a href="/user/chat/{{$book['id']}}/{{urlencode($book['healthcare'][0]['name'])}}" > 
																<i class="fa fa-wechat"></i>
																<span>Chat</span>
														 </a> 
														</div>
														<div class="lp-list-pay-btn">
															@if($book['is_confirmed'] == 0 || $book['is_confirmed'] == 1)  <a href="/user/cancel/{{$book['id']}}/{{urlencode($book['healthcare'][0]['name'])}}" onclick="return confirm('Are you sure?')"> @else <a href="javascript::void(0)" onclick="alert('Its already cancelled'); return false">  @endif
																<i class="fa fa-close"></i>
																<span>Cancel</span>
															  </a> 
														</div>
...
<h4 class="no-bookings">No haven't made any booking</h4>
											</div>
											</div>
@endif
									</div>
