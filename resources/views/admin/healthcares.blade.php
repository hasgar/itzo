					...
					<div class="tab-pane fade active in" id="dashborad">
						<div class="dashboard-tab">
							...
							<div class="user-recent-listings-container">
									...
									<a href="/admin/addHealthcare" class="lp-primary-btn btn-second-hover"><i class="fa fa-plus"></i> Add Healthcare</a>   <a href="/logout" class="lp-secondary-btn btn-second-hover">Sign Out</a>
...
@if($healthcare['payment_done'] != 1)
														<div class="lp-list-pay-btn">
															  <a href="/admin/healthcare/paymentDone/{{$healthcare['id']}}/{{urlencode($healthcare['name'])}}" onclick="return confirm('Are you sure?')"> <i class="fa fa-check"></i>
