					...
					<div class="tab-pane fade active in" id="dashborad">
						<div class="dashboard-tab">
							...
							<div class="user-recent-listings-container">
									...
									<a href="/addHealthcare" class="lp-primary-btn btn-second-hover"><i class="fa fa-plus"></i> Add Healthcare</a>   <a href="/logout" class="lp-secondary-btn btn-second-hover">Sign Out</a>
