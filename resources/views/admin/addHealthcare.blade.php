					...
					<div class="tab-pane fade active in" id="dashborad">
						<div class="dashboard-tab">
							...
							<div class="user-recent-listings-container">
									<div class="col-md-8"><h3 class="padding-top-35 padding-bottom-35"></h3></div><div class="col-md-4"><div class="price-plan-button  pull-right">
...
">
                  ...
                  <form id="add-healthcare" class="form-horizontal margin-top-30" role="form" method="POST" action="/admin/addHealthcare" enctype='multipart/form-data'>
